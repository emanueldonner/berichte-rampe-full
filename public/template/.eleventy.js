...
module.exports = function (eleventyConfig) {
  ...
  for (let i = 0; i < chapters.length; i++) {
    ...
    eleventyConfig.addCollection(chapter.folder, function(collectionApi) {
      ...
      var col = collectionApi.getFilteredByGlob(`${path}/src/pages/kapitel/${chapter.folder}/*.njk`)
  ...
  //   "./src/images": "/images",
  //   "./src/images_static": "/images_static",
  //   "./src/files": "/files",
  //   "./src/assets/": "/assets/",
  //   "./src/favicon": "/",
  // });

  eleventyConfig.addPassthroughCopy(`${path}/src/images`);
  eleventyConfig.addPassthroughCopy(`${path}/src/images_static`);
  eleventyConfig.addPassthroughCopy(`${path}/src/files`);
  eleventyConfig.addPassthroughCopy(`${path}/src/assets`);
